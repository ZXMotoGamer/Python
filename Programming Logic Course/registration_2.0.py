...
try:
    while True:
        ...
        if first_name == "":
            ...
            first_name.isdigit()
        ):  # [New comment] I added an "elif" here using ".isdigit()" to stop numerical inputs being accepted.
            print("\nSorry, that is not a valid name please try again.")
        else:
            break
    while True:
    ...
    # for the First and Last name inputs I used "IF/Else" statements inside of "while" loops to ensure that a name was entered. I also used ".strip()" to make sure spaces were treated the same as no input at all. finally I used ".capitalize()" to well of course capitalize the first letters of the names.
    ...
    while True:
        try:
            ...
            if (
                tickets > 999999999999999999999999999999999
            ):  # [New comment] This was to ensure that no amount of tickets would exceed the alignment of the final presented output.
                print(
                    "Sorry, that is too many tickets for one purchase. Please reduce the amount of tickets."
                )
                continue
            elif tickets > 0:
                break
                ...
                print(
                    "\nTickets are required for entry. Please enter the number of tickets you need."
                )
                continue
        except ValueError:
            print("\nSorry, you must enter a numerical number please try again.")
...
# [New comment] The "exception" above is to catch any possible errors that may happen and is a safe guard.

print("\n\tThank you for registering.\n\n")
# ----------------------------------------------------------[Code End]--------------------------------------------------------------------------

# [New comment] I could not figure out how to write code for "additional tickets". I'll be asking about it in class.
